namespace Mapsui.Forms.Converter
{
	...
	/// <summary>
	/// Converter to longitude.
	/// </summary>
	public class ConverterToLongitude : IValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			...
			{
				return string.Format((string)parameter, Converter.NumberToLongitude(pos.Longitude));
			}
			else
			{
				return Converter.NumberToLongitude(pos.Longitude);
			}
		}
